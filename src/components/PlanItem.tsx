...
export const PlanItem = (props: PlanItemProps) => {
  ...
  return (
    <Box w="full" minH="500" border='1px' borderColor='gray.200' p='6' borderRadius='2xl' {...priorityStyles}>
        ...
        <List>
          {features?.map(feature => (
              <ListItem fontSize="xl"><ListIcon as={FaCheckCircle} /> {feature}</ListItem>
          ))}
        </List>
    </Box>
  )
